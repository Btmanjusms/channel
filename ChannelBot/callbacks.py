...
async def _callbacks(bot: Client, callback_query: CallbackQuery):
    ...
    await bot.db.check_user(user_id)
    ...
    if query.startswith("home"):
        ...
        if text:
            ...
            await bot.db.remove_channel(user_id, channel_id)
            await callback_query.message.delete()
    elif query.startswith('change'):
        change = query.split('+')[1]
        channel_id = int(query.split('+')[2])
        success, info = await bot.db.get_channel_info(channel_id)
        if success:
            ...
            if change == 'caption':
                ...
                if current_position == 'below':
                    ...
                    new_position = 'below'
                await bot.db.set_position(channel_id, new_position)
                ...
                if current_edit_mode == 'all':
                    ...
                    new_edit_mode = 'all'
                await bot.db.set_edit_mode(channel_id, new_edit_mode)
                text, markup, __ = await channel_settings(channel_id, bot)
                if text:
                    await callback_query.edit_message_text(text, reply_markup=InlineKeyboardMarkup(markup), disable_web_page_preview=True)
                else:
                ...
                if current.lower() == 'true':
                    ...
                    new = True
                await bot.db.toggle_webpage_preview(channel_id, new)
                text, markup, __ = await channel_settings(channel_id, bot)
                if text:
                    await callback_query.edit_message_text(text, reply_markup=InlineKeyboardMarkup(markup), disable_web_page_preview=True)
                else:
        ...
        try:
            if add == 'caption':
                ...
                if data.text.lower() == '/cancel':
                    ...
                    await bot.db.set_caption(channel_id, data.text.markdown)
                ...
                while True:
                    ...
                    if "-" not in data.text:
                        ...
                        try:
                            ...
                            await bot.db.set_buttons(channel_id, data.text)
                ...
                await bot.db.set_sticker(channel_id, data.sticker.file_id)
        ...
        if len(args) == 2:
            ...
            if remove == 'caption':
                await bot.db.set_caption(channel_id, None)
                ...
                await bot.db.set_buttons(channel_id, None)
                ...
                await bot.db.set_sticker(channel_id, None)
        ...
        channel_id = int(query.split('+')[1])
        sticker_id = await bot.db.get_sticker(channel_id)
        if sticker_id:
